...
//===== Define Fuzzy beta =====
   ...
   this.beta_NC.toolTip =
      ...
      "Use beta > 1 to lift respectively beta \&lt; 1 to lower the fuzzy function. " +
      "Values between 1.1 and 1.5 are typical.</p>";
...
//===== Define CB Replace =====
   ...
   this.replace_Label.toolTip =
      ...
      "<p>With this option selected, the process will replace the target image by the modified image. " +
